...
20 CLS:REM THIS CLEARS THE SCREEN
25 Y=Y
...
420 IF V1$="LOOK" THEN CLS: RD(R)=0: GOTO 610
...
590 IF R>0 THEN X=R:CLS:GOTO 610:REM YOU'VE MOVED AND X WILL BE USED IN SEARCHING FOR OBJECTS
