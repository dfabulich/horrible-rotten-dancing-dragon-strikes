...
20 PRINT CHR$(125):REM THIS CLEARS THE SCREEN
30 DIM N(34),S(34),E(34),W(34),OB(7),RD(34),A$20,DES$(40),N1$(20),V1$(20)
...
130 PRINT CHR$(125):PRINT DES$
140 IF LEN(A$)=0 THEN GOTO 100
150 FOR A=1 TO LEN(A$)
160 IF A$(A,A)=" " THEN V1$=A$(1,A-1):N1%=A$(A+1):A=0:GOTO 300
170 NEXT A
180 V1$=A$
...
550 IF V1$="WEST" OR V1$="E" THEN R = W(R)
...
590 IF R>0 THEN X=R:PRINT CHR$(125):GOTO 610:REM YOU'VE MOVED AND X WILL BE USED IN SEARCHING FOR OBJECTS
...
950 IF OB(1)=23 THEN GOTO 3060
IF N1$="BUTTON" THEN GOTO 3050
970 GOTO 3040
...
1845 "WILL NOT ERUPT DURING THIS GAME.":RD(R)=1:RETURN
...
2200 SUBROUTINE TO CHECK NOUNS
...
3385 "KRUPA (WHO?), BUT YOU'LL";:PRINT "DO IN A PINCH.":GOTO 100
